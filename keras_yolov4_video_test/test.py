...
# python test.py -c model_data/obj.names -m yolov4_custom_weights_22000.h5 -a model_data/yolo4_anchors.txt
...
if __name__ == '__main__':
    ...
    ap.add_argument('-c','--classes_path',default = 'model_data/yolov4_cls.names',required =True,help='Path to class names file')
    ...
    # model_path = 'yolov4_custom_weights_22000.h5'
